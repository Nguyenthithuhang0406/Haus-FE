                        ...
                        <div className="pl-[2%] pt-[2%] lg:w-1/5 ">
                            <div className="p-1 border-b-2 lg:border-b-0 lg:border-r-2">
                                <nav className="space-y-2">
                                    <Link to="/view-infor" className="block w-full text-left py-3 px-4 rounded bg-[#ad7555]/10 text-[#ad7555] font-medium border-l-4 border-[#ad7555]">
                                        Thông tin tài khoản
                                    </Link>
                                    <Link
                                        to="#"
                                ...
                                <div className="flex flex-col lg:flex-row gap-10 p-[2%]">
                                    ...
                                    <div className=" mx-auto lg:w-1/4">
                                        ...
                                        <div className=" relative rounded-2xl overflow-hidden shadow-md">
                                            <img src="avt_img\avt.jpg" alt="Uploaded" className="w-full aspect-square object-cover rounded-lg" />
                                        ...
                                        <button
                                            className="mt-3 w-full px-6 bg-[#ad7555] text-white font-medium py-2.5 rounded-md border border-[#ad7555] hover:bg-white hover:text-[#ad7555] transition duration-200 text-sm"
                                        >
                                            Cập nhật ảnh
                                        </button>
                                    </div>
                                            ...
                                            <div className="space-y-1">
                                                <div className="grid grid-cols gap-6">
                                                    <div className="bg-gray-50 p-1 rounded-lg">
                                                        <span className="font-medium text-gray-700 block mb-1">Họ tên:</span>
                                                        <span className="text-gray-800 text-lg">{userInfo.name}</span>
                                                    </div>
                                                    <div className="bg-gray-50 p-1 rounded-lg">
                                                    ...
                                                    <div className="bg-gray-50 p-1 rounded-lg">
                                                        <span className="font-medium text-gray-700 block mb-1">Điện thoại:</span>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className={`w-full px-4 py-3 bg-gray-50 border rounded-md focus:outline-none focus:ring-2 ${errors.name
