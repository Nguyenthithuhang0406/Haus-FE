...
import Menua from '@/components/admin/Menua';
    ...
    if (selectedType === 'Theo đơn hàng') {
      return (
        <div className="space-y-4">
          <div className="grstt grstt-cols-2 gap-4">
            
            
          </div>
          <div className="grstt grstt-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Giá trị đơn hàng tối thiểu <span className= "text-red-300">*</span></label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Giá trị đơn hàng tối đa <span className= "text-red-300">*</span></label>
              <div className="relative">
                <input
                  type="number"
                  name="priceEnd"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Giá trị khuyến mãi <span className= "text-red-300">*</span></label>
        ...
        <div className='flex  justify-end mb-8'>
          <button
            ...
            className="bg-[#ad7555] text-white border-2 border-[#ad7555] 
             ...
             px-3 py-2 rounded-none  flex items-center justify-center gap-2 
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  ...
                  {/* Filter Row */}
                  <tr className="bg-white border-1 border-gray-300">
                    <td className="px-4 py-3">
                      <input
                        ...
                        placeholder="STT"
                        className="w-full px-3 py-2 text-sm border border-gray-300 rounded-none  focus:outline-none  text-center transition-colors"
                      />
                    </td>
                    <td className="px-4 py-3">
                      <select
                        ...
                        onChange={handleFilterChange}
                        className="w-full px-3 py-2 text-sm border border-gray-300 rounded-none  focus:outline-none  text-center transition-colors bg-white"
                      >
            ...
            <div className="p-4 space-y-3 bg-gray-50 border-b border-gray-200">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <input
                  ...
                  className="px-3 py-2 text-sm border border-gray-300 rounded-none  focus:outline-none"
                />
                <select
                  name="promotionType"
                  value={filters.promotionType}
                  onChange={handleFilterChange}
                  className="px-3 py-2 text-sm border border-gray-300 rounded-none  focus:outline-none  text-center bg-white"
                >
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-none  p-6 w-full max-w-xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Kiểu khuyến mãi</label>
                <select
                  name="promotionType"
