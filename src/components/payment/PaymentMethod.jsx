                ...
                <label className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 cursor-pointer mb-4 w-full">
                    ...
                    <div className="flex flex-1 gap-3 sm:gap-4 items-start sm:items-center w-full">
                        ...
                        <div className="flex flex-col flex-1 w-full">
                            ...
                            <span
                                className={`flex flex-1 rounded-lg py-3 px-3 sm:py-4 sm:px-4 text-[14px] shadow-lg transition w-full ${selected === "cod"
                ...
                <label className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 cursor-pointer mb-4 w-full">
                    ...
                    <div className="flex flex-1 gap-3 sm:gap-4 items-start sm:items-center w-full">
                        ...
                        <div className="flex flex-col flex-1 w-full">
                            ...
                            <span
                                className={`flex justify-between items-center rounded-lg py-2 px-3 sm:py-3 sm:px-4 text-[14px] shadow-lg transition w-full ${selected === "vnpay"
                                    ? "border border-[#ad7555] bg-[#f9f5f3] text-gray-800"
                                    : "border border-gray-200 text-gray-700"
                                    }`}
                            >
                                <p>VN Pay</p>
                                <img src={pc1} alt="anhminhhoa" className="w-6 h-6 sm:w-8 sm:h-8" />
                            </span>
                        </div>
                    </div>
                </label>
                ...
                <label className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 cursor-pointer w-full">
                    ...
                    <div className="flex flex-1 gap-3 sm:gap-4 items-start sm:items-center w-full">
                        ...
                        <div className="flex flex-col flex-1 w-full">
                            ...
                            <span
                                className={`flex justify-between items-center rounded-lg py-2 px-3 sm:py-3 sm:px-4 text-[14px] shadow-lg transition w-full ${selected === "momo"
                                    ? "border border-[#ad7555] bg-[#f9f5f3] text-gray-800"
                                    : "border border-gray-200 text-gray-700"
                                    }`}
                            >
                                <p>Momo</p>
                                <img src={pc2} alt="anhminhhoa" className="w-6 h-6 sm:w-8 sm:h-8" />
                            </span>
                        </div>
                    </div>
                </label>
