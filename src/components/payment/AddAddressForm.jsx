  ...
  const handleSubmit = async (values) => {
    try {
      const data = {
        ...
        country: "Việt Nam",
        city:
          provinces.find((p) => p.code.toString() === values.province)?.name ||
          "",
        district:
          districts.find((d) => d.code.toString() === values.district)?.name ||
          "",
        commune:
          wards.find((w) => w.code.toString() === values.ward)?.name || "",
