        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50">
            <div className="bg-white rounded-2xl shadow-lg 
                ...
                <div className="flex justify-between items-start p-4 sm:p-6">
                    ...
                    <button onClick={() => setViewItem(null)} className="text-gray-500 hover:text-gray-700">
                        <X size={22} />
                    </button>
                </div>
                ...
                <div className="flex-1 overflow-y-auto px-4 sm:px-6 space-y-6 sm:space-y-8 pb-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                        ...
                        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3 text-sm">
                            ...
                            <p className="col-span-1 sm:col-span-2 flex items-center gap-2">
                                <b>Trạng thái:</b>
                                <span
                                    className={`px-2 py-1 rounded-lg text-xs font-medium ${item.status === "Hiển thị"
                            ...
                            <p className="col-span-1 sm:col-span-2"><b>Mô tả ngắn:</b> {item.shortDesc}</p>
                    ...
                    <div className="sm:w-1/2">
                        <h3 className="text-gray-500 font-medium mb-2">Thông tin tồn kho</h3>
                        <div className="bg-gray-50 border border-gray-300 rounded-xl p-4">
                            <div className="flex justify-between text-sm">
                                <span>Sản phẩm tồn kho:</span>
                                <b>{item.stock} sản phẩm</b>
                            </div>
                        </div>
                    </div>
                        ...
                        <table className="w-full border border-gray-300 text-sm min-w-[500px]">
                            ...
                            <tbody>
                                <tr key={item.id} className="text-center border border-gray-300">
                                    ...
                                    <td className="p-2 border border-gray-300">{item.price.toLocaleString()}đ</td>
                    ...
                    {/* Variants */}
                    <div className="overflow-x-auto">
                        <h3 className="text-gray-700 font-medium">Biến thể sản phẩm</h3>
                            ...
                            <tbody>
                                {variants.length > 0 ? (
                                    variants.map((variant) => (
                                        <tr key={variant.id} className="text-center border border-gray-300 hover:bg-gray-50">
                                            <td className="p-2 border border-gray-300">
                                                <img
                                            ...
                                            <td className="p-2 border border-gray-300">{variant.color}</td>
                                            <td className="p-2 border border-gray-300">{variant.price?.toLocaleString()}đ</td>
                                            <td className="p-2 border border-gray-300">{variant.stock}</td>
                                            <td className="p-2 border border-gray-300">
                                                <div className="flex justify-center gap-3">
                                                    <button
                ...
                {showVariantModal && (
                    <VariantModal
                        ...
                        onAddVariant={handleAddOrUpdateVariant}
                    />
                )}
