                ...
                <div className="bg-gray-50 flex items-center justify-center py-8 px-4">
                    <div className="max-w-sm w-full bg-white rounded-lg shadow-md p-6">
                        <div className="text-center mb-6">
                            <h1 className="text-xl font-bold text-gray-800 mb-2">QUÊN MẬT KHẨU</h1>
                        ...
                        <div className="space-y-4">
                            ...
                            {resetEmailSent && (
                                <div className="mb-4 p-3 bg-green-100 border border-green-300 rounded-md">
                                    <p className="text-green-800 text-sm">
                                        Chúng tôi đã gửi OTP đến email của bạn. Vui lòng kiểm tra để đặt lại mật khẩu
                                    </p>
                                </div>
                            )}
                            ...
                            <div>
                                <input
                                    ...
                                    className={`w-full px-3 py-2.5 bg-gray-100 border rounded-md focus:outline-none focus:ring-2 focus:border-transparent text-sm ${forgotEmailError
                                    ...
                                    <div className="mt-2 text-center">
                                        {countdown > 0 ? (
                                            <p className="text-gray-600 text-xs">
                                                Gửi lại OTP sau: <span className="font-medium text-[#b4805d]">{formatTime(countdown)}</span>
                                            </p>
                                        ) : (
                            ...
                            >
                                {resetEmailSent ? 'Xác nhận OTP' : 'Lấy lại mật khẩu'}
                            </button>
                                ...
                                <div className="flex">
                                    <div className="flex-1 px-4">
                                        <button className="w-full bg-[#3b5998] hover:bg-blue-700 text-white py-1 flex items-center justify-center space-x-3 transition duration-200 text-sm">
                                            <span className="pr-3 border-r border-[#2a498c]"><i className="fa-brands fa-facebook-f"></i></span>
                                            <span>Facebook</span>
                                        </button>
                                    </div>
                                    <div className="flex-1 px-4">
                                        <button className="w-full bg-[#e14b33] hover:bg-red-600 text-white py-1 flex items-center justify-center space-x-3 transition duration-200 text-sm">
                                            <span className="pr-3 border-r border-[#ce452f]"><i className="fa-brands fa-google-plus-g"></i></span>
                                            <span>Google</span>
                                        </button>
                                    </div>
                                </div>
